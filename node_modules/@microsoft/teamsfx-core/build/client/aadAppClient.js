...
class AadAppClient {
    ...
    constructor(m365TokenProvider, logProvider) {
        ...
        this.axios.interceptors.request.use(async (config) => {
            this.logProvider?.debug((0, localizeUtils_1.getLocalizedString)("core.common.SendingApiRequest", config.url, JSON.stringify(config.data)));
        ...
        this.axios.interceptors.response.use((response) => {
            this.logProvider?.debug((0, localizeUtils_1.getLocalizedString)("core.common.ReceiveApiResponse", JSON.stringify(response.data)));
            return response;
        });
        ...
        (0, axios_retry_1.default)(this.axios, {
            ...
            retryDelay: axios_retry_1.default.exponentialDelay, // exponetial delay time: Math.pow(2, retryNumber) * 100
        ...
        try {
            ...
            if (axios_1.default.isAxiosError(err) && err.response) {
                if (err.response.data?.error?.code === constants_2.aadErrorCode.signInAudienceNotAllowedAsPerAppPolicy) {
                    throw new signInAudienceNotAllowedError_1.SignInAudienceNotAllowedError(AadAppClient.name, err.response.data.error?.message, isMicrosoftUser);
                }
            }
            throw err;
        }
