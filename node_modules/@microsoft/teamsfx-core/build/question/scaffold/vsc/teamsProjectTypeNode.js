        ...
        data: {
            ...
            additionalValidationOnAccept: {
                validFunc: async (value, inputs) => {
                    ...
                    try {
                        const tools = await (0, mcpToolFetcher_1.readMCPToolsFromFile)(filePath);
                        if (inputs) {
        ...
        data: {
            ...
            additionalValidationOnAccept: {
                validFunc: async (value, inputs) => {
                    ...
                    if (inputs.platform !== teamsfx_api_1.Platform.VSCode) {
                        try {
                            const result = await (0, mcpToolFetcher_1.fetchMCPTools)(value);
...
function updateActionWithMCP() {
    return {
        data: {
            ...
            default: (inputs) => path_1.default.normalize(path_1.default.join(inputs.projectPath, teamsfx_api_1.AppPackageFolderName, teamsfx_api_1.DefaultPluginManifestFileName)),
        },
        children: [
            {
                data: {
