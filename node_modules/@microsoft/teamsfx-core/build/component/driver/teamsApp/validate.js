...
let ValidateManifestDriver = class ValidateManifestDriver {
    ...
    progressTitle = (0, localizeUtils_1.getLocalizedString)("plugins.appstudio.validateManifest.progressBar.message");
    ...
    async validate(args, context) {
        ...
        const actionErrorCount = declarativeAgentValidationResult?.actionValidationResult
            .filter((o) => o.filePath !== "")
    ...
    async validateLocalizatoinFiles(args, context, manifest) {
        ...
        if (manifestVersion && semver_1.default.gte(manifestVersion, "1.19.0")) {
            defaultLanguageTag = manifest.localizationInfo
                ?.defaultLanguageTag;
...
exports.ValidateManifestDriver = ValidateManifestDriver = tslib_1.__decorate([
