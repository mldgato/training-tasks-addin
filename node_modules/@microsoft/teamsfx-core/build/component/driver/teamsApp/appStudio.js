...
async function updateManifestV3(ctx, inputs) {
    ...
    const manifestTemplatePath = inputs.manifestTemplatePath ?? ManifestUtils_1.manifestUtils.getTeamsAppManifestPath(inputs.projectPath);
...
async function updateTeamsAppV3ForPublish(ctx, inputs) {
    ...
    if (validationError) {
        ...
        ctx.logProvider?.error((0, localizeUtils_1.getLocalizedString)("plugins.appstudio.validationFailedNotice"));
            ...
            switch (name) {
                ...
                default:
                    ...
                    if (constants_3.supportedLanguageCodes.findIndex((code) => code === base) > -1) {
                        ...
                        logProvider?.warning((0, localizeUtils_1.getLocalizedString)("plugins.appstudio.unprocessedFile", name));
                    }
            }
        });
