...
let PublishAppPackageDriver = class PublishAppPackageDriver {
    description = (0, localizeUtils_1.getLocalizedString)("driver.teamsApp.description.publishDriver");
    progressTitle = (0, localizeUtils_1.getLocalizedString)("driver.teamsApp.progressBar.publishTeamsAppStep2.2");
    ...
    async publish(args, context, outputEnvVarNames) {
        ...
        const declarativeAgents = manifest.copilotExtensions?.declarativeCopilots || manifest.copilotAgents?.declarativeAgents;
        ...
        try {
            ...
            if (existApp) {
                ...
                if (existApp.lastModifiedDateTime) {
                    description =
                        description +
                            (0, localizeUtils_1.getLocalizedString)("plugins.appstudio.lastModified", existApp.lastModifiedDateTime?.toLocaleString());
                }
                description =
    ...
    async verifyLocalMCPPluginCerts(pluginFile) {
        ...
        for (const runtime of localPluginRuntimes) {
            const localEndpoint = runtime.spec
                ?.local_endpoint;
            if (!localEndpoint || !localEndpoint.startsWith(constants_3.LocalMcpPrefix)) {
                continue;
            }
            const mcpIdentifier = localEndpoint.substring(constants_3.LocalMcpPrefix.length);
    ...
    async verifyPackageFamilyCertIsValid(packageName) {
...
exports.PublishAppPackageDriver = PublishAppPackageDriver = tslib_1.__decorate([
