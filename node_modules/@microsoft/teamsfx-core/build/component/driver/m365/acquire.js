    ...
    async handler(args, context, outputEnvVarNames) {
        try {
            ...
            if (error instanceof teamsfx_api_1.UserError || error instanceof teamsfx_api_1.SystemError) {
                context.logProvider?.error((0, localizeUtils_1.getLocalizedString)(constants_2.logMessageKeys.failExecuteDriver, exports.actionName, error.displayMessage));
                throw error;
            }
