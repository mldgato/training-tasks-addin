...
let CreateApiKeyDriver = class CreateApiKeyDriver {
    description = (0, localizeUtils_1.getLocalizedString)("driver.apiKey.description.create");
    progressTitle = (0, localizeUtils_1.getLocalizedString)("driver.aadApp.apiKey.title.create");
        ...
        try {
            ...
            if (state && state.registrationId) {
                try {
                    ...
                    context.logProvider?.info((0, localizeUtils_1.getLocalizedString)(constants_3.logMessageKeys.skipCreateApiKey, outputEnvVarNames.get(createApiKeyOutputs_1.OutputKeys.registrationId)));
                }
                catch (error) {
                    context.logProvider?.warning((0, localizeUtils_1.getLocalizedString)(constants_3.logMessageKeys.apiKeyNotFound, outputEnvVarNames.get(createApiKeyOutputs_1.OutputKeys.registrationId)));
                }
            }
            else {
...
exports.CreateApiKeyDriver = CreateApiKeyDriver = tslib_1.__decorate([
